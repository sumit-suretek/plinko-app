...
// 										   ,'Resources/highpoints.wav']);
	...
	Qlinqo.defaultFillColor = new Qlinqo.Util.ColorRGBA(236, 27, 75, 1);//(0,128,0,255);
	Qlinqo.defaultStrokeColor = new Qlinqo.Util.ColorRGBA(236, 27, 75, 1);//(0,102,34,255);
...
Qlinqo.newGamePiece = function(x, y) {
	...
	if(Qlinqo.ballsLeft > 0)
	{
		...
		console.log('after: ' + Qlinqo.gamePieces[0] instanceof Qlinqo.GamePiece);
